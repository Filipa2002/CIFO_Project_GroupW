...
# This module implements the Genetic Algorithm for the Music Festival Lineup Optimization Problem.
...
def get_best_ind(population: list[LineupSolutionGA], maximization: bool):
...
def genetic_algorithm(
    initial_population: list[LineupSolutionGA],
    max_gen: int,
